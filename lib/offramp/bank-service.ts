...
export const NIGERIAN_BANKS: Bank[] = [
  { id: "1", name: "Access Bank", code: "044", logo: "https://nigerianbanks.xyz/logo/access-bank.png" },
  { id: "2", name: "Guaranty Trust Bank", code: "058", logo: "https://nigerianbanks.xyz/logo/guaranty-trust-bank.png" },
  { id: "3", name: "First Bank of Nigeria", code: "011", logo: "https://nigerianbanks.xyz/logo/first-bank-of-nigeria.png" },
  { id: "4", name: "United Bank for Africa", code: "033", logo: "https://nigerianbanks.xyz/logo/united-bank-for-africa.png" },
  { id: "5", name: "Zenith Bank", code: "057", logo: "https://nigerianbanks.xyz/logo/zenith-bank.png" },
  { id: "6", name: "Stanbic IBTC Bank", code: "221", logo: "https://nigerianbanks.xyz/logo/stanbic-ibtc-bank.png" },
  { id: "7", name: "Sterling Bank", code: "232", logo: "https://nigerianbanks.xyz/logo/sterling-bank.png" },
  { id: "8", name: "Union Bank of Nigeria", code: "032", logo: "https://nigerianbanks.xyz/logo/union-bank-of-nigeria.png" },
  { id: "9", name: "Wema Bank", code: "035", logo: "https://nigerianbanks.xyz/logo/wema-bank.png" },
  { id: "10", name: "Fidelity Bank", code: "070", logo: "https://nigerianbanks.xyz/logo/fidelity-bank.png" },
  { id: "11", name: "Kuda Bank", code: "50211", logo: "https://nigerianbanks.xyz/logo/kuda-bank.png" },
  ...
  { id: "14", name: "Moniepoint", code: "50515", logo: "https://nigerianbanks.xyz/logo/moniepoint.png" },
  { id: "15", name: "First City Monument Bank", code: "214", logo: "https://nigerianbanks.xyz/logo/first-city-monument-bank.png" },
];
...
export async function verifyAccountNumber(bankCode: string, accountNumber: string): Promise<string> {
  // Simulate API delay
...
export function saveAccount(account: Omit<BankAccount, "id">): BankAccount {
  ...
  const updated = [newAccount, ...saved.filter(a => a.accountNumber !== account.accountNumber || a.bankCode !== account.bankCode)];
...
export async function signKycMessage(address: string, amount: number, accountNumber: string): Promise<string> {
  const message = `I authorize AFRAMP to send ₦${amount.toLocaleString()} to account ${accountNumber}`;
